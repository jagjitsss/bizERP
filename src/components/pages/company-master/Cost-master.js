...
const rows = [
  createData('Cost Center Name 1', "Location 1 ", "otherdetails 1"),
  createData('Cost Center Name 2', "Location 2 ", "otherdetails 1"),
  createData('Cost Center Name 3', "Location 3 ", "otherdetails 1"),
  createData('Cost Center Name 4', "Location 1 ", "otherdetails 1"),
  createData('Cost Center Name 5', "Location 1 ", "otherdetails 1"),
  
 
];

function Cost_master (){
