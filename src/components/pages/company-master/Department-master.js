...
const rows = [
  createData('Department 1', "Location 1 ", "otherdetails 1"),
  createData('Department 2', "Location 2 ", "otherdetails 2"),
  createData('Department 3', "Location 3 ", "otherdetails 3"),
  createData('Department 4', "Location 4 ", "otherdetails 4"),
  createData('Department 5', "Location 5 ", "otherdetails 5"),
