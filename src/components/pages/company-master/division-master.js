...
const rows = [
  createData('Divison1', "Address", "otherdetails1"),
  createData('Divison2',"Address", "otherdetails2"),
  createData('Divison3', "Address", "otherdetails3"),
  createData('Divison4', "Address", "otherdetails4"),
  createData('Divison5', "Address", "otherdetails5"),
];
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow className={classes.tbrwoe}>
            <TableCell >Divison Name</TableCell>
