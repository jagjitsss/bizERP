...
const rows = [
  createData('Godown 1', "Location 1 ", "otherdetails 1","Please Select"),
  createData('Godown 2', "Location 2 ", "otherdetails 2 ","Please Select"),
  createData('Godown 3', "Location 3 ", "otherdetails 3","Please Select"),
  createData('Godown 4', "Location 4 ", "otherdetails 4 ","Please Select"),
  createData('Godown 5', "Location 5 ", "otherdetails 5","Please Select"),
      ...
      <Table className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow className={classes.tbrwoe}>
            ...
            <TableCell align="right">Other Details</TableCell>
